...
class Program
{
    ...
    // Counts occurrence of each unique character in the array of chars
    ...
    // Gets the sorted ranking of the passed word amongst all its permuations
    ...
    // wordEnding        - ending of word to get permutations ahead of
    ...
    static long GetPermutationsAheadOfWord(HashSet<char> lesserChars, string wordEnding, Dictionary<char, int> countOfCharacters) {
      ...
      // 1) Pick a lesserChar and pretend-swap it to the front of wordEnding
